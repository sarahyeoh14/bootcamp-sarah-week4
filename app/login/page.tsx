    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight">Vantage</h1>
          <p className="text-slate-400 text-sm mt-2">Product Intelligence · Mindvalley</p>
        </div>
        ...
        <div className="bg-slate-800/60 backdrop-blur border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? 'Signing in…' : 'Enter Vantage'}
            </button>
          </form>
        </div>
