    ...
    <div className="flex flex-col h-full bg-slate-900 border-r border-slate-800">
      ...
      <div className="px-5 py-5 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-white text-sm font-semibold leading-tight">Vantage</div>
            <div className="text-slate-500 text-xs">Product Intelligence</div>
          </div>
        </div>
        {onClose && (
          <button
    ...
    <>
      ...
      <div className="sm:hidden fixed top-0 left-0 right-0 z-30 flex items-center gap-3 bg-slate-900 border-b border-slate-800 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white text-sm font-semibold">Vantage</span>
        </div>
      </div>
